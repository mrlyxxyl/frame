...
<head>
    ...
    <script type="text/javascript" src="${baseUrl}/js/jquery.gvChart-1.0.1.min.js"></script>
    <script type="text/javascript" src="${baseUrl}/js/jquery.ba-resize.min.js"></script>
