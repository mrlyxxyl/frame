...
<head>
    ...
    <link href="${baseUrl}/css/select.css" rel="stylesheet" type="text/css"/>
    <script type="text/javascript" src="${baseUrl}/js/jquery.js"></script>
    <script type="text/javascript" src="${baseUrl}/js/jquery.idTabs.min.js"></script>
    <script type="text/javascript" src="${baseUrl}/js/select-ui.min.js"></script>
    <script type="text/javascript" src="${baseUrl}/editor/kindeditor.js"></script>

    <script type="text/javascript">
        KE.show({
            id: 'content7',
            cssPath: '${baseUrl}/css/index.css'
        });
    </script>
