...
<div class="form_body">
    ...
    <ul class="form_info">
        <li><label>文章标题</label><input name="" type="text" class="df_input"/><i>标题不能超过30个字符</i></li>
        <li><label>关键字</label><input name="" type="text" class="df_input"/><i>多个关键字用,隔开</i></li>
        <li><label>是否审核</label><cite><input name="" type="radio" value="" checked="checked"/>是&nbsp;&nbsp;&nbsp;&nbsp;<input name="" type="radio" value=""/>否</cite></li>
        <li><label>引用地址</label><input name="" type="text" class="df_input" value="http://www..com/html/uidesign/"/></li>
